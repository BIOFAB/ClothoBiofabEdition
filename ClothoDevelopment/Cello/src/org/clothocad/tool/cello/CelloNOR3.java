 ...
 * @author rozagh
 */
public class CelloNOR3 extends CelloGates{

    public CelloNOR3()
    {
        _ipromoter1 = new CelloIPromoter();
        _ipromoter2 = new CelloIPromoter();
        _ipromoter3 = new CelloIPromoter();
        _rbs1 = new CelloRBS();
        ...
        _nor.add(2, _ipromoter2);
        _nor.add(3, _rbs1);
        _nor.add(4, _gene1);
        _nor.add(5, _t1);
        _nor.add(6, _rpromoter);
        _nor.add(7, _rbs2);
        _nor.add(8, _gene2);
        _nor.add(9, _t2);
    ...
    public CelloIPromoter getIPromoter3()
    {
        return this._ipromoter3;// (CelloIPromoter) _nor.get(1);
    }
    ...
    public void setIPromoter3(CelloIPromoter ip3)
    {
        _nor.set(2, ip3);
        this._ipromoter2 = new CelloIPromoter(ip3);
         this._graph.Vertices.get(2).Feature = ip3;
    }
    ...
    public void setRBS1(CelloRBS rbs1)
    {
        ...
        this._graph.Vertices.get(3).Feature = rbs1;
    }
    ...
    public void setRBS2(CelloRBS rbs2)
    {
        ...
        this._rbs2  = new CelloRBS(rbs2);
         this._graph.Vertices.get(7).Feature = rbs2;
    }
    ...
    public void setGene1(CelloGene cg1)
    {
        ...
        this._gene1 = new CelloGene(cg1);
         this._graph.Vertices.get(4).Feature = cg1;
    ...
    public void setGene2(CelloGene cg2)
    {
        ...
        this._graph.Vertices.get(8).Feature = cg2;
    ...
    public void setRPromoter(CelloRPromoter rp1)
    {
        ...
        this._graph.Vertices.get(6).Feature = rp1;
     ...
     public void setTerminator1 (CelloTerminator ct1)
    {
        ...
        this._t1  = new CelloTerminator(ct1);
         this._graph.Vertices.get(5).Feature = ct1;
      ...
      public void setTerminator2 (CelloTerminator ct2)
    {
        ...
        this._t2  = new CelloTerminator(ct2);
         this._graph.Vertices.get(9).Feature = ct2;
    ...
    private void makeGraph ()
    {
        ...
        DAGVertex vipromoter3 = new DAGVertex("ipromoter3", _ipromoter3.getClass().toString(), null, _ipromoter3);
        ...
        DAGEdge eip3torbs1 = new DAGEdge( vrbs1,vipromoter3, null);
        ...
        this._graph.Vertices.add(vipromoter3);
        ...
        this._graph.Edges.add(eip3torbs1);
    ...
    private void makeEquiGraph ()
    {
        ...
        DAGVertex v3 = new DAGVertex("~", "31", null);
        DAGVertex v4 = new DAGVertex("|", "34", null);

        DAGEdge e1 = new DAGEdge(v1, v2, null);
        DAGEdge e2 = new DAGEdge(v2, v3, null);
        DAGEdge e3 = new DAGEdge(v3, v4, null);

        this._equiGraph.Vertices.add(v1);
        this._equiGraph.Vertices.add(v2);
        this._equiGraph.Vertices.add(v3);
        this._equiGraph.Vertices.add(v4);
        this._equiGraph.Edges.add(e1);
        this._equiGraph.Edges.add(e2);
        this._equiGraph.Edges.add(e3);
    ...
    private CelloIPromoter _ipromoter3;
