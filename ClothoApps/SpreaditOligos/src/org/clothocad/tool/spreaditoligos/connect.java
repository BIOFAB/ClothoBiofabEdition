...
public class connect implements ClothoTool {
    ...
    public void launch() {
        ...
        Preferences _prefs = Preferences.userNodeForPackage(spreaditOligos.class);
        ...
        if(launchcoll!=null) {
            spreaditOligos v = new spreaditOligos(launchcoll);
            pig.add(new WeakReference(v));
            return;
        }
        Collection chosen = new Collection();
        spreaditOligos v = new spreaditOligos(chosen);
        pig.add(new WeakReference(v));
    }
